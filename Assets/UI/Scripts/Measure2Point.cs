...
public class Measure2Point : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        selectAction = InputSystem.actions.FindAction("RoomBuilderControl/Select");
    }
    ...
    private void Update()
    {
        ...
        if (selectAction.WasPressedThisFrame())
        {
            ...
            new(Camera.main.transform.position, Camera.main.transform.forward);
        ...
        if (pos1 != Vector3.zero && pos2 != Vector3.zero)
        {
            ...
            measure.GetComponent<MeshRenderer>().material = Resources.Load<Material>("Materials/Green_AlwaysOnTop");
