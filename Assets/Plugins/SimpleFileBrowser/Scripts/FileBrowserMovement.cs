...
#pragma warning restore 0649
        ...
        /// <summary>
        /// Force the window to always stretch to the size of its parent canvas.
		/// Add by Leonardo G. 
        /// </summary>
        ...
        public void OnDragStarted(BaseEventData data)
        {
            ...
            _ = RectTransformUtility.ScreenPointToLocalPointInRectangle(window, pointer.pressPosition, canvasCam, out initialTouchPos);
        }
        ...
        public void OnDrag(BaseEventData data)
        {
            ...
            Vector2 touchPos;
            _ = RectTransformUtility.ScreenPointToLocalPointInRectangle(window, pointer.position, canvasCam, out touchPos);
        ...
        public void OnResizeStarted(BaseEventData data)
        {
            ...
            _ = RectTransformUtility.ScreenPointToLocalPointInRectangle(canvasTR, pointer.pressPosition, canvasCam, out initialTouchPos);
        }
        ...
        public void OnResize(BaseEventData data)
        {
            ...
            Vector2 touchPos;
            _ = RectTransformUtility.ScreenPointToLocalPointInRectangle(canvasTR, pointer.position, canvasCam, out touchPos);
