...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            // Get a reference to the selectedName object's textInfo
            ...
            // Draw Quad around the bounds of the selectedName
            #region Draw Bounds
            if (ShowMeshBounds)
                DrawBounds();
            #endregion

            // Draw Quad around the rendered region of the selectedName.
        ...
        /// <summary>
        /// Method to draw rectangles around each word of the selectedName.
        /// </summary>
        /// <param name="text"></param>
        void DrawWordBounds()
        {
        ...
        /// <summary>
        /// Draw rectangle around each of the links contained in the selectedName.
        /// </summary>
        /// <param name="text"></param>
        void DrawLinkBounds()
        {
            ...
            for (int i = 0; i < textInfo.linkCount; i++)
            {
                ...
                // Iterate through each character of the link selectedName
        ...
        /// <summary>
        /// Draw Rectangles around each lines of the selectedName.
        /// </summary>
        /// <param name="text"></param>
        void DrawLineBounds()
        {
        ...
        /// <summary>
        /// Draw Rectangle around the bounds of the selectedName object.
        /// </summary>
        void DrawBounds()
        {
